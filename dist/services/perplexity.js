...
7. Photo opportunities`;
    ...
    buildScheduleOptimizationQuery(params) {
...
export const perplexityClient = new PerplexityService(process.env.PERPLEXITY_API_KEY || '');
