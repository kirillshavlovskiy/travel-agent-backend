...
Return ONLY valid JSON with schedule array.`;
        ...
        const sortedActivities = validActivities.sort((a, b) => (b.preferenceScore - a.preferenceScore) || ((b.rating || 0) - (a.rating || 0)));
        ...
        const optimizeSchedule = async (activities, days, destination) => {
            try {
...
- activityFitNotes: why activities were included/excluded`;
        ...
        const createBasicSchedule = (activities, days) => {
            const schedule = [];
            let activityIndex = 0;
        ...
        try {
            ...
            optimizedSchedule.schedule.forEach((day) => {
            ...
            const transformedActivities = optimizedSchedule.schedule.flatMap((day) => day.activities.map((activity) => {
            ...
            res.json({
                ...
                schedule: optimizedSchedule.schedule.map((day) => ({
                    dayNumber: day.dayNumber,
                    planningLogic: day.dayPlanningLogic,
...
- activityFitNotes: why activities were included/excluded`;
                ...
                chedActivity = await viatorClient.enrichActivityDetails({
                    ...bestMatch,
                    name: name || bestMatch.name,
                    referenceUrl: bestMatch.referenceUrl
                });
