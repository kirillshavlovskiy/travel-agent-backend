 ...
 */
export function enhanceActivityCategories(activity) {
 ...
 */
export function enhanceActivityRatings(activity) {
 ...
 */
export function createFastPacedOptions(activities, days) {
    ...
    const optionsByDayAndSlot = new Map();
